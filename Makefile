...
install: translate
	...
	cp -r lang icons donate.gif gnome_connection_manager.py gnome-connection-manager.glade icon.png pyAES.py SimpleGladeApp.py ssh.expect urlregex.py style.css $(DESTDIR)/usr/share/gnome-connection-manager/
